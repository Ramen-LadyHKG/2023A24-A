...
alias update='sudo pacman -Syu --ignore "linux*" --ignore "*surface*"'
alias viv='vivaldi-stable'

###################

if [ -f /etc/zsh-completion ]; then
	. /etc/zsh_completion
fi
...
# Created by `pipx` on 2023-05-16 11:07:13
export PATH="$PATH:/home/curie/.local/bin"
